...
export default class StudentRouter implements IRouter {
    public setupRoutes(application: Application, resources: IApplicationResources) {
        ...
        application.get("/student/getStudentIdByUserId/:id", AuthMiddleware.getVerifier("user", "fakeAdmin"), studentController.getStudentIdByUserId.bind(studentController));
